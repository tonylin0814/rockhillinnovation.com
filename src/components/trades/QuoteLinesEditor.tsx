      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead>{text.costRmb}</TableHead>
            <TableHead>{text.previousCost}</TableHead>
            <TableHead>{text.change}</TableHead>
            <TableHead>{text.changePct}</TableHead>
